...
oonn.graphics.drawing.brushes.fill = function( context ){
  
  this.initialize.apply(this, arguments);
  
}

_.extend( oonn.graphics.drawing.brushes.fill.prototype, {
  
  initialize: function( context ){
    this.context = context;
    this.LINE_WIDTH = 1;
    this.STROKE_STYLE = 'pink';// '#000';
	...
	stroke: function( mouseX, mouseY ){
	  ...
	  if( mouseX && mouseY && this.prevX && this.prevY ){
  	  ...
  	  this.context.lineWidth = this.LINE_WIDTH;
  		...
  		//this.context.fillStyle = 'lightgray'//this.FILL_STYLE;
