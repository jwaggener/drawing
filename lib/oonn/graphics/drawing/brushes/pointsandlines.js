...
oonn.graphics.drawing.brushes.pointsandlines = function( context ){
  
  this.initialize.apply(this, arguments);
  
}

_.extend( oonn.graphics.drawing.brushes.pointsandlines.prototype, {
  ...
  strokeStart: function( mouseX, mouseY ){
	...
	stroke: function( mouseX, mouseY ){
      ...
      this.context.beginPath();
  		...
  		this.context.beginPath();
  		this.context.arc( this.prevX, this.prevY, this.RADIUS, 0, 2*Math.PI );
  		this.context.fill();
  		this.context.closePath();
		}
		this.prevX = mouseX;
