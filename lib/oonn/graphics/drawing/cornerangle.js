...
oonn.graphics.drawing.cornerangle = function( context ){
  
  this.initialize.apply(this, arguments);
  
}

_.extend( oonn.graphics.drawing.cornerangle.prototype, {
  ...
  renderLine: function( x, y ){
    if ( x != null ){
      this.context.moveTo( 0, -(x * this.scale/2) );//produces a 45 degree angle?
